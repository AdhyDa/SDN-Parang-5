    ...
    <>
      ...
      <main className="flex-1 bg-white">
        ...
        <section className="section-padding">
          <div className="container-section max-w-4xl">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold font-heading text-navy mb-6">
              Perjalanan SDN Parang 5 Magetan
            </h2>
            ...
            {profilData?.history ? (
              ...
              <div className="prose max-w-none text-gray-600 font-body leading-relaxed flex flex-col gap-4 text-justify">
                <p>
                  ...
                  dusun Jurang Kunci, Desa Parang, Kecamatan Parang, Kabupaten Magetan, Provinsi Jawa
                ...
                <p>
                  ...
                  menjadi warga masyarakat Magetan yang berbakti dan produktif. Komitmen kami
        ...
        <section className="section-padding bg-light">
          <div className="container-section max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-10">
            {/* Visi (takes 5 cols) */}
